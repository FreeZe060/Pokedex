        ...
        <header class="fixed top-0 w-screen z-10 bg-[#001353] shadow-navbar">
            <div class="flex items-center justify-between p-4 px-20 max-h-[88px]">
                ...
                <div>
                    <ul class="flex">
                        <li class="m-0">
                            <Link href="/#home" class="p-[2.2rem] px-[3rem] inline-block text-[1.6rem] uppercase tracking-[1px] font-bold text-white transition hover:translate-y-[-2px] duration-300"> Home </Link>
                        </li>
                        <li class="m-0">
